    ...
    _onSuccess(data) {
        if (data) {
            if (data.success) {
                ...
                //http://localhost:1337/2fa/   from Kingfisher: Authy-2
                hashHistory.push('/verification');
                            ...
                            <form id="login-form" ref='user_form' role="form" onSubmit={this._handleSubmit.bind(this)} >
                                ...
                                <div class="form-group">
                                    ...
                                    <button id="login-button" type="submit"
                                        class="btn   pull-right" disabled={this.state.loading}><span className="sign-in">SIGN IN</span>
